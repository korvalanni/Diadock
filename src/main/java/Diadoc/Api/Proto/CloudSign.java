...
public final class CloudSign {
  ...
  public interface CloudSignRequestOrBuilder extends
     ...
     */
    java.util.List<Diadoc.Api.Proto.CloudSign.CloudSignFile> 
        getFilesList();
    /**
     * <code>repeated .Diadoc.Api.Proto.CloudSignFile Files = 1;</code>
     */
    Diadoc.Api.Proto.CloudSign.CloudSignFile getFiles(int index);
    /**
     * <code>repeated .Diadoc.Api.Proto.CloudSignFile Files = 1;</code>
     */
    int getFilesCount();
     ...
     * <code>repeated .Diadoc.Api.Proto.CloudSignFile Files = 1;</code>
     */
    java.util.List<? extends Diadoc.Api.Proto.CloudSign.CloudSignFileOrBuilder> 
        getFilesOrBuilderList();
    /**
     * <code>repeated .Diadoc.Api.Proto.CloudSignFile Files = 1;</code>
     */
    Diadoc.Api.Proto.CloudSign.CloudSignFileOrBuilder getFilesOrBuilder(
        int index);
  }
  /**
  ...
  public static final class CloudSignRequest extends
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                files_ = new java.util.ArrayList<Diadoc.Api.Proto.CloudSign.CloudSignFile>();
                mutable_bitField0_ |= 0x00000001;
              }
              files_.add(input.readMessage(Diadoc.Api.Proto.CloudSign.CloudSignFile.PARSER, extensionRegistry));
              break;
            }
          }
        }
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Diadoc.Api.Proto.CloudSign.internal_static_Diadoc_Api_Proto_CloudSignRequest_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return Diadoc.Api.Proto.CloudSign.internal_static_Diadoc_Api_Proto_CloudSignRequest_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Diadoc.Api.Proto.CloudSign.CloudSignRequest.class, Diadoc.Api.Proto.CloudSign.CloudSignRequest.Builder.class);
    }
    ...
    private java.util.List<Diadoc.Api.Proto.CloudSign.CloudSignFile> files_;
    /**
     * <code>repeated .Diadoc.Api.Proto.CloudSignFile Files = 1;</code>
     */
    public java.util.List<Diadoc.Api.Proto.CloudSign.CloudSignFile> getFilesList() {
      return files_;
    }
    /**
     * <code>repeated .Diadoc.Api.Proto.CloudSignFile Files = 1;</code>
     */
    public java.util.List<? extends Diadoc.Api.Proto.CloudSign.CloudSignFileOrBuilder> 
        getFilesOrBuilderList() {
      return files_;
    }
    /**
     ...
     * <code>repeated .Diadoc.Api.Proto.CloudSignFile Files = 1;</code>
     */
    public Diadoc.Api.Proto.CloudSign.CloudSignFile getFiles(int index) {
      return files_.get(index);
    }
    /**
     * <code>repeated .Diadoc.Api.Proto.CloudSignFile Files = 1;</code>
     */
    public Diadoc.Api.Proto.CloudSign.CloudSignFileOrBuilder getFilesOrBuilder(
        int index) {
      return files_.get(index);
    }
    ...
    public static Diadoc.Api.Proto.CloudSign.CloudSignRequest parseFrom(
    ...
    public static Diadoc.Api.Proto.CloudSign.CloudSignRequest parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Diadoc.Api.Proto.CloudSign.CloudSignRequest parseFrom(
    ...
    public static Diadoc.Api.Proto.CloudSign.CloudSignRequest parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static Diadoc.Api.Proto.CloudSign.CloudSignRequest parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static Diadoc.Api.Proto.CloudSign.CloudSignRequest parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(Diadoc.Api.Proto.CloudSign.CloudSignRequest prototype) {
    ...
    public static final class Builder extends
        ...
        Diadoc.Api.Proto.CloudSign.CloudSignRequestOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Diadoc.Api.Proto.CloudSign.internal_static_Diadoc_Api_Proto_CloudSignRequest_descriptor;
      }
      ...
      // Construct using Diadoc.Api.Proto.CloudSign.CloudSignRequest.newBuilder()
      private Builder() {
      ...
      public Diadoc.Api.Proto.CloudSign.CloudSignRequest getDefaultInstanceForType() {
        return Diadoc.Api.Proto.CloudSign.CloudSignRequest.getDefaultInstance();
      }

      public Diadoc.Api.Proto.CloudSign.CloudSignRequest build() {
        Diadoc.Api.Proto.CloudSign.CloudSignRequest result = buildPartial();
      ...
      public Diadoc.Api.Proto.CloudSign.CloudSignRequest buildPartial() {
        Diadoc.Api.Proto.CloudSign.CloudSignRequest result = new Diadoc.Api.Proto.CloudSign.CloudSignRequest(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Diadoc.Api.Proto.CloudSign.CloudSignRequest) {
          return mergeFrom((Diadoc.Api.Proto.CloudSign.CloudSignRequest)other);
        } else {
      ...
      public Builder mergeFrom(Diadoc.Api.Proto.CloudSign.CloudSignRequest other) {
        if (other == Diadoc.Api.Proto.CloudSign.CloudSignRequest.getDefaultInstance()) return this;
        if (filesBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Diadoc.Api.Proto.CloudSign.CloudSignRequest parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Diadoc.Api.Proto.CloudSign.CloudSignRequest) e.getUnfinishedMessage();
          throw e;
        } finally {
      ...
      private void ensureFilesIsMutable() {
        if (!((bitField0_ & 0x00000001) == 0x00000001)) {
          files_ = new java.util.ArrayList<Diadoc.Api.Proto.CloudSign.CloudSignFile>(files_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilder<
          Diadoc.Api.Proto.CloudSign.CloudSignFile, Diadoc.Api.Proto.CloudSign.CloudSignFile.Builder, Diadoc.Api.Proto.CloudSign.CloudSignFileOrBuilder> filesBuilder_;
      ...
      public Builder setFiles(
          int index, Diadoc.Api.Proto.CloudSign.CloudSignFile value) {
        if (filesBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setFiles(
          int index, Diadoc.Api.Proto.CloudSign.CloudSignFile.Builder builderForValue) {
        if (filesBuilder_ == null) {
          ensureFilesIsMutable();
       ...
       * <code>repeated .Diadoc.Api.Proto.CloudSignFile Files = 1;</code>
       */
      public Builder addFiles(Diadoc.Api.Proto.CloudSign.CloudSignFile value) {
        if (filesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addFiles(
          Diadoc.Api.Proto.CloudSign.CloudSignFile.Builder builderForValue) {
        if (filesBuilder_ == null) {
          ensureFilesIsMutable();
      ...
      public Builder addAllFiles(
          java.lang.Iterable<? extends Diadoc.Api.Proto.CloudSign.CloudSignFile> values) {
        if (filesBuilder_ == null) {
          ensureFilesIsMutable();
       ...
       * <code>repeated .Diadoc.Api.Proto.CloudSignFile Files = 1;</code>
       */
      public Diadoc.Api.Proto.CloudSign.CloudSignFile.Builder getFilesBuilder(
          int index) {
       ...
       * <code>repeated .Diadoc.Api.Proto.CloudSignFile Files = 1;</code>
       */
      public Diadoc.Api.Proto.CloudSign.CloudSignFile.Builder addFilesBuilder() {
        return getFilesFieldBuilder().addBuilder(
            Diadoc.Api.Proto.CloudSign.CloudSignFile.getDefaultInstance());
      }
      /**
       * <code>repeated .Diadoc.Api.Proto.CloudSignFile Files = 1;</code>
       */
      public Diadoc.Api.Proto.CloudSign.CloudSignFile.Builder addFilesBuilder(
          int index) {
        return getFilesFieldBuilder().addBuilder(
            index, Diadoc.Api.Proto.CloudSign.CloudSignFile.getDefaultInstance());
      }
      /**
       * <code>repeated .Diadoc.Api.Proto.CloudSignFile Files = 1;</code>
       */
      public java.util.List<Diadoc.Api.Proto.CloudSign.CloudSignFile.Builder> 
           getFilesBuilderList() {
        return getFilesFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          Diadoc.Api.Proto.CloudSign.CloudSignFile, Diadoc.Api.Proto.CloudSign.CloudSignFile.Builder, Diadoc.Api.Proto.CloudSign.CloudSignFileOrBuilder> 
          getFilesFieldBuilder() {
        if (filesBuilder_ == null) {
  ...
  public static final class CloudSignFile extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Diadoc.Api.Proto.CloudSign.internal_static_Diadoc_Api_Proto_CloudSignFile_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return Diadoc.Api.Proto.CloudSign.internal_static_Diadoc_Api_Proto_CloudSignFile_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Diadoc.Api.Proto.CloudSign.CloudSignFile.class, Diadoc.Api.Proto.CloudSign.CloudSignFile.Builder.class);
    }
    ...
    public static Diadoc.Api.Proto.CloudSign.CloudSignFile parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static Diadoc.Api.Proto.CloudSign.CloudSignFile parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Diadoc.Api.Proto.CloudSign.CloudSignFile parseFrom(
    ...
    public static Diadoc.Api.Proto.CloudSign.CloudSignFile parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static Diadoc.Api.Proto.CloudSign.CloudSignFile parseFrom(
    ...
    public static Diadoc.Api.Proto.CloudSign.CloudSignFile parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static Diadoc.Api.Proto.CloudSign.CloudSignFile parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(Diadoc.Api.Proto.CloudSign.CloudSignFile prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        ...
        Diadoc.Api.Proto.CloudSign.CloudSignFileOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Diadoc.Api.Proto.CloudSign.internal_static_Diadoc_Api_Proto_CloudSignFile_descriptor;
      }
      ...
      // Construct using Diadoc.Api.Proto.CloudSign.CloudSignFile.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public Diadoc.Api.Proto.CloudSign.CloudSignFile getDefaultInstanceForType() {
        return Diadoc.Api.Proto.CloudSign.CloudSignFile.getDefaultInstance();
      }

      public Diadoc.Api.Proto.CloudSign.CloudSignFile build() {
        Diadoc.Api.Proto.CloudSign.CloudSignFile result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public Diadoc.Api.Proto.CloudSign.CloudSignFile buildPartial() {
        Diadoc.Api.Proto.CloudSign.CloudSignFile result = new Diadoc.Api.Proto.CloudSign.CloudSignFile(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Diadoc.Api.Proto.CloudSign.CloudSignFile) {
          return mergeFrom((Diadoc.Api.Proto.CloudSign.CloudSignFile)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(Diadoc.Api.Proto.CloudSign.CloudSignFile other) {
        if (other == Diadoc.Api.Proto.CloudSign.CloudSignFile.getDefaultInstance()) return this;
        if (other.hasContent()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Diadoc.Api.Proto.CloudSign.CloudSignFile parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Diadoc.Api.Proto.CloudSign.CloudSignFile) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  public static final class CloudSignResult extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Diadoc.Api.Proto.CloudSign.internal_static_Diadoc_Api_Proto_CloudSignResult_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return Diadoc.Api.Proto.CloudSign.internal_static_Diadoc_Api_Proto_CloudSignResult_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Diadoc.Api.Proto.CloudSign.CloudSignResult.class, Diadoc.Api.Proto.CloudSign.CloudSignResult.Builder.class);
    }
    ...
    public static Diadoc.Api.Proto.CloudSign.CloudSignResult parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static Diadoc.Api.Proto.CloudSign.CloudSignResult parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Diadoc.Api.Proto.CloudSign.CloudSignResult parseFrom(
    ...
    public static Diadoc.Api.Proto.CloudSign.CloudSignResult parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static Diadoc.Api.Proto.CloudSign.CloudSignResult parseFrom(
    ...
    public static Diadoc.Api.Proto.CloudSign.CloudSignResult parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static Diadoc.Api.Proto.CloudSign.CloudSignResult parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(Diadoc.Api.Proto.CloudSign.CloudSignResult prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        ...
        Diadoc.Api.Proto.CloudSign.CloudSignResultOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Diadoc.Api.Proto.CloudSign.internal_static_Diadoc_Api_Proto_CloudSignResult_descriptor;
      }
      ...
      // Construct using Diadoc.Api.Proto.CloudSign.CloudSignResult.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public Diadoc.Api.Proto.CloudSign.CloudSignResult getDefaultInstanceForType() {
        return Diadoc.Api.Proto.CloudSign.CloudSignResult.getDefaultInstance();
      }

      public Diadoc.Api.Proto.CloudSign.CloudSignResult build() {
        Diadoc.Api.Proto.CloudSign.CloudSignResult result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public Diadoc.Api.Proto.CloudSign.CloudSignResult buildPartial() {
        Diadoc.Api.Proto.CloudSign.CloudSignResult result = new Diadoc.Api.Proto.CloudSign.CloudSignResult(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Diadoc.Api.Proto.CloudSign.CloudSignResult) {
          return mergeFrom((Diadoc.Api.Proto.CloudSign.CloudSignResult)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(Diadoc.Api.Proto.CloudSign.CloudSignResult other) {
        if (other == Diadoc.Api.Proto.CloudSign.CloudSignResult.getDefaultInstance()) return this;
        if (other.hasToken()) {
          bitField0_ |= 0x00000001;
          token_ = other.token_;
          onChanged();
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Diadoc.Api.Proto.CloudSign.CloudSignResult parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Diadoc.Api.Proto.CloudSign.CloudSignResult) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  public static final class CloudSignConfirmResult extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Diadoc.Api.Proto.CloudSign.internal_static_Diadoc_Api_Proto_CloudSignConfirmResult_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return Diadoc.Api.Proto.CloudSign.internal_static_Diadoc_Api_Proto_CloudSignConfirmResult_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult.class, Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult.Builder.class);
    }
    ...
    public static Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult parseFrom(
    ...
    public static Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult parseFrom(
    ...
    public static Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        ...
        Diadoc.Api.Proto.CloudSign.CloudSignConfirmResultOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Diadoc.Api.Proto.CloudSign.internal_static_Diadoc_Api_Proto_CloudSignConfirmResult_descriptor;
      }
      ...
      // Construct using Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult getDefaultInstanceForType() {
        return Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult.getDefaultInstance();
      }

      public Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult build() {
        Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult buildPartial() {
        Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult result = new Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult(this);
        int from_bitField0_ = bitField0_;
        if (signaturesBuilder_ == null) {
          if (((bitField0_ & 0x00000001) == 0x00000001)) {
            signatures_ = java.util.Collections.unmodifiableList(signatures_);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult) {
          return mergeFrom((Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult other) {
        if (other == Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult.getDefaultInstance()) return this;
        if (signaturesBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Diadoc.Api.Proto.CloudSign.CloudSignConfirmResult) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  public static final class AutosignReceiptsResult extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Diadoc.Api.Proto.CloudSign.internal_static_Diadoc_Api_Proto_AutosignReceiptsResult_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return Diadoc.Api.Proto.CloudSign.internal_static_Diadoc_Api_Proto_AutosignReceiptsResult_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult.class, Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult.Builder.class);
    }
    ...
    public static Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult parseFrom(
    ...
    public static Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult parseFrom(
    ...
    public static Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        ...
        Diadoc.Api.Proto.CloudSign.AutosignReceiptsResultOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return Diadoc.Api.Proto.CloudSign.internal_static_Diadoc_Api_Proto_AutosignReceiptsResult_descriptor;
      }
      ...
      // Construct using Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult getDefaultInstanceForType() {
        return Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult.getDefaultInstance();
      }

      public Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult build() {
        Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult buildPartial() {
        Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult result = new Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult) {
          return mergeFrom((Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult other) {
        if (other == Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Diadoc.Api.Proto.CloudSign.AutosignReceiptsResult) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
