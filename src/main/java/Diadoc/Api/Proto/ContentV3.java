...
public final class ContentV3 {
  ...
  public interface Content_v3OrBuilder extends
     ...
     * <code>optional .Diadoc.Api.Proto.DocumentId EntityId = 3;</code>
     */
    Diadoc.Api.Proto.DocumentIdOuterClass.DocumentId getEntityId();
    /**
     * <code>optional .Diadoc.Api.Proto.DocumentId EntityId = 3;</code>
     */
    Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdOrBuilder getEntityIdOrBuilder();
  ...
  public static final class Content_v3 extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              ...
              entityId_ = input.readMessage(Diadoc.Api.Proto.DocumentIdOuterClass.DocumentId.PARSER, extensionRegistry);
              if (subBuilder != null) {
    ...
    private Diadoc.Api.Proto.DocumentIdOuterClass.DocumentId entityId_;
    /**
     * <code>optional .Diadoc.Api.Proto.DocumentId EntityId = 3;</code>
     */
     ...
     * <code>optional .Diadoc.Api.Proto.DocumentId EntityId = 3;</code>
     */
    public Diadoc.Api.Proto.DocumentIdOuterClass.DocumentId getEntityId() {
      return entityId_;
    }
    /**
     * <code>optional .Diadoc.Api.Proto.DocumentId EntityId = 3;</code>
     */
    public Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdOrBuilder getEntityIdOrBuilder() {
      return entityId_;
    }
    ...
    private void initFields() {
      ...
      nameOnShelf_ = "";
      entityId_ = Diadoc.Api.Proto.DocumentIdOuterClass.DocumentId.getDefaultInstance();
      patchedContentId_ = "";
    }
  ...
  bitField0_ |= 0x00000002;
      ...
      private Diadoc.Api.Proto.DocumentIdOuterClass.DocumentId entityId_ = Diadoc.Api.Proto.DocumentIdOuterClass.DocumentId.getDefaultInstance();
      private com.google.protobuf.SingleFieldBuilder<
          Diadoc.Api.Proto.DocumentIdOuterClass.DocumentId, Diadoc.Api.Proto.DocumentIdOuterClass.DocumentId.Builder, Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdOrBuilder> entityIdBuilder_;
      /**
       * <code>optional .Diadoc.Api.Proto.DocumentId EntityId = 3;</code>
       */
      public boolean hasEntityId() {
       ...
       * <code>optional .Diadoc.Api.Proto.DocumentId EntityId = 3;</code>
       */
      public Builder setEntityId(Diadoc.Api.Proto.DocumentIdOuterClass.DocumentId value) {
        if (entityIdBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>optional .Diadoc.Api.Proto.DocumentId EntityId = 3;</code>
       */
      public Builder mergeEntityId(Diadoc.Api.Proto.DocumentIdOuterClass.DocumentId value) {
        if (entityIdBuilder_ == null) {
          if (((bitField0_ & 0x00000004) == 0x00000004) &&
              entityId_ != Diadoc.Api.Proto.DocumentIdOuterClass.DocumentId.getDefaultInstance()) {
            entityId_ =
              Diadoc.Api.Proto.DocumentIdOuterClass.DocumentId.newBuilder(entityId_).mergeFrom(value).buildPartial();
          } else {
            entityId_ = value;
          }
          onChanged();
       ...
       * <code>optional .Diadoc.Api.Proto.DocumentId EntityId = 3;</code>
       */
      public Diadoc.Api.Proto.DocumentIdOuterClass.DocumentId.Builder getEntityIdBuilder() {
        bitField0_ |= 0x00000004;
        onChanged();
