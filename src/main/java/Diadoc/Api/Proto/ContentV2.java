...
public final class ContentV2 {
  ...
  public interface Content_v2OrBuilder extends
     ...
     * <code>optional .Diadoc.Api.Proto.DocumentIdEx DocumentId = 4;</code>
     */
    Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdEx getDocumentId();
    /**
     * <code>optional .Diadoc.Api.Proto.DocumentIdEx DocumentId = 4;</code>
     */
    Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdExOrBuilder getDocumentIdOrBuilder();
  }
  /**
  ...
  public static final class Content_v2 extends
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdEx.Builder subBuilder = null;
              if (((bitField0_ & 0x00000008) == 0x00000008)) {
                subBuilder = documentId_.toBuilder();
              }
              documentId_ = input.readMessage(Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdEx.PARSER, extensionRegistry);
              if (subBuilder != null) {
    ...
    private Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdEx documentId_;
    /**
     * <code>optional .Diadoc.Api.Proto.DocumentIdEx DocumentId = 4;</code>
     */
     ...
     * <code>optional .Diadoc.Api.Proto.DocumentIdEx DocumentId = 4;</code>
     */
    public Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdEx getDocumentId() {
      return documentId_;
    }
    /**
     * <code>optional .Diadoc.Api.Proto.DocumentIdEx DocumentId = 4;</code>
     */
    public Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdExOrBuilder getDocumentIdOrBuilder() {
      return documentId_;
    }
    ...
    private void initFields() {
      ...
      nameOnShelf_ = "";
      patchedContentId_ = "";
      documentId_ = Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdEx.getDefaultInstance();
    }
  ...
  bitField0_ |= 0x00000004;
      ...
      private Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdEx documentId_ = Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdEx.getDefaultInstance();
      private com.google.protobuf.SingleFieldBuilder<
          Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdEx, Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdEx.Builder, Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdExOrBuilder> documentIdBuilder_;
      /**
       * <code>optional .Diadoc.Api.Proto.DocumentIdEx DocumentId = 4;</code>
       */
      public boolean hasDocumentId() {
       ...
       * <code>optional .Diadoc.Api.Proto.DocumentIdEx DocumentId = 4;</code>
       */
      public Builder setDocumentId(Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdEx value) {
        if (documentIdBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setDocumentId(
          Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdEx.Builder builderForValue) {
        if (documentIdBuilder_ == null) {
       ...
       * <code>optional .Diadoc.Api.Proto.DocumentIdEx DocumentId = 4;</code>
       */
      public Builder mergeDocumentId(Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdEx value) {
        if (documentIdBuilder_ == null) {
          if (((bitField0_ & 0x00000008) == 0x00000008) &&
              documentId_ != Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdEx.getDefaultInstance()) {
            documentId_ =
              Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdEx.newBuilder(documentId_).mergeFrom(value).buildPartial();
          } else {
            documentId_ = value;
          }
          onChanged();
       ...
       * <code>optional .Diadoc.Api.Proto.DocumentIdEx DocumentId = 4;</code>
       */
      public Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdEx.Builder getDocumentIdBuilder() {
        bitField0_ |= 0x00000008;
        onChanged();
       ...
       */
      private com.google.protobuf.SingleFieldBuilder<
          Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdEx, Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdEx.Builder, Diadoc.Api.Proto.DocumentIdOuterClass.DocumentIdExOrBuilder> 
          getDocumentIdFieldBuilder() {
        if (documentIdBuilder_ == null) {
